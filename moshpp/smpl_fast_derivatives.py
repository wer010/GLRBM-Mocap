...
from gmm_prior_ch import AliasedBetas, create_gmm_body_prior
...
def load_moshpp_models(num_beta_shared_models=12):
    """
    load model
    """
    sm_temp = load_surface_model(surface_model_fname='data/models/smpl/SMPL_NEUTRAL.pkl',
    ...
    priors = {}
    priors['pose'] = create_gmm_body_prior(pose_body_prior_fname='/home/lanhai/Projects/HPE/support_data/smplx/pose_body_prior.pkl',
                                        exclude_hands=False)
    priors['betas'] = AliasedBetas(sv=can_model, surface_model_type='smpl')
